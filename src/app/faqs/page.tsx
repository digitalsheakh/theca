...
export default function FAQs() {
 ...
 <Link 
 href="/" 
 className="inline-block border-2 border-white text-white hover:bg-[#f97316] hover:text-white px-8 py-4 font-bold uppercase font-orbitron tracking-wider transition-all duration-300 hover:scale-105 active:scale-95"
 >
 Back to Home
 </Link>
 </div>
