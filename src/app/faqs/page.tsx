      ...
      <div className="w-full px-6">
        <div className="max-w-screen-xl mx-auto">
            ...
            <div className="space-y-4">
              {faqData.carService.map((faq) => (
                <motion.div
                  key={faq.id}
                  variants={fadeInUp}
                  className="bg-black border border-orange-600/20 rounded-lg overflow-hidden hover:border-orange-600 transition-colors duration-300"
                >
                  <button
          ...
          <motion.div
            ...
            viewport={{ once: true, amount: 0.3 }}
            variants={fadeInUp}
            className="text-center bg-black border border-orange-600/20 rounded-2xl p-12"
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link 
                href="/" 
                className="inline-block border-2 border-white text-white hover:bg-white hover:text-black px-8 py-4 font-bold uppercase font-orbitron tracking-wider transition-all duration-300 rounded-lg"
              >
                Back to Home
              </Link>
            </div>
