    ...
    <div className="min-h-screen bg-black text-white pt-20 md:pt-32">
        ...
        <div className="relative z-10 container mx-auto px-8 h-full flex items-center">
          <div className="max-w-4xl">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-8 font-orbitron uppercase tracking-wider leading-tight bg-black/50 p-4">
              <TitleBadge title="CARBON CLEANING SERVICES" className='mb-2' />
              CARBON CLEAN
            </h1>
      ...
      <section className="py-10 md:py-20 bg-black">
        <div className="container mx-auto px-8">
          {/* Section Header */}
          <div className="mb-16">
            <TitleBadge title="PROFESSIONAL ENGINE CARBON CLEANING" className="mb-8 pl-6" />
            ...
            <div className="max-w-4xl">
              ...
              <p className="text-base text-gray-300 mb-6 font-rajdhani leading-relaxed">
                At <span className="text-white font-semibold">The Car Edition</span>, we use professional carbon cleaning equipment to remove deposits from your engine without dismantling. The process is quick, effective, and restores your engine to peak performance.
              </p>
              <a
                href="https://www.youtube.com/watch?v=p_1jrIhxGPU"
                target="_blank"
