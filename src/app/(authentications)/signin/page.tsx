...
function LoginPage() {
 ...
 <div className="animate-spin h-16 w-16 border-4 border-orange-600 border-t-transparent mx-auto mb-6"></div>
 ...
 className="mb-6 p-4 bg-orange-900/50 text-orange-300 text-sm border border-orange-500/30 font-rajdhani"
 >
 {error}
 </motion.div>
 )}
 ...
 className={`w-full px-4 py-3 bg-white text-white font-rajdhani ${errors.email ?"border-orange-500" :"border-gray-600"} border focus:ring-2 focus:ring-gray-600 focus:border-gray-600 placeholder-gray-400`}
 ...
 className={`w-full px-4 py-3 bg-white text-white font-rajdhani ${errors.password ?"border-orange-500" :"border-gray-600"} border focus:ring-2 focus:ring-gray-600 focus:border-gray-600 placeholder-gray-400`}
 placeholder="••••••••"
 />
 {errors.password && (
 ...
 name="remember-me"
 type="checkbox"
 className="h-4 w-4 text-orange-600 focus:ring-orange-600 border-gray-600 bg-white"
 />
 ...
 type="submit"
 disabled={loading}
 className={`group relative w-full flex justify-center items-center py-4 px-4 border border-transparent shadow-lg text-sm font-bold font-orbitron uppercase tracking-wider text-white overflow-hidden transition-all duration-300 ${
 loading 
