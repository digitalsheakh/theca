                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input type="text" value="47,995" className="w-full bg-gray-800 border border-gray-600 rounded-lg pl-8 pr-4 py-3 text-white font-rajdhani focus:outline-none focus:ring-2 focus:ring-orange-600" />
                    </div>
                  </div>
                  <div>
                    <label className="block text-gray-400 font-rajdhani mb-2">Interest Rate *</label>
                    <div className="relative">
                      <input type="text" value="6" className="w-full bg-gray-800 border border-gray-600 rounded-lg px-4 py-3 text-white font-rajdhani focus:outline-none focus:ring-2 focus:ring-orange-600" />
                      <span className="absolute right-3 top-3 text-gray-400">%</span>
                    </div>
                  </div>
                  <div>
                    <label className="block text-gray-400 font-rajdhani mb-2">Period (months) *</label>
                    <input type="text" value="36" className="w-full bg-gray-800 border border-gray-600 rounded-lg px-4 py-3 text-white font-rajdhani focus:outline-none focus:ring-2 focus:ring-orange-600" />
                  </div>
                  <div>
                    <label className="block text-gray-400 font-rajdhani mb-2">Down Payment</label>
                    <div className="relative">
                      <span className="absolute left-3 top-3 text-gray-400">£</span>
                      <input type="text" value="4,800" className="w-full bg-gray-800 border border-gray-600 rounded-lg pl-8 pr-4 py-3 text-white font-rajdhani focus:outline-none focus:ring-2 focus:ring-orange-600" />
                    </div>
                  </div>
                </div>
