          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="space-y-4">
                <button className="w-full bg-white hover:bg-[#f97316] text-white p-4 transition-all duration-300 font-rajdhani border border-orange-600/30">
                  <FaPhone className="inline mr-2" />
                  441 *** *** - reveal
                </button>
                <button className="w-full bg-black hover:bg-gray-900 text-white p-4 transition-all duration-300 font-orbitron font-bold border border-orange-600/30">
                  Send message
                </button>
              </div>

              {/* Vehicle Description */}
              <div className="bg-black/40 border border-orange-600/30 p-8 backdrop-blur-sm">
              ...
              <div className="bg-gray-900/50 backdrop-blur-sm border border-orange-600/30 p-6">
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input type="text" value="6" className="w-full bg-white border border-orange-600/30 px-4 py-3 text-white font-rajdhani focus:outline-none focus:ring-2 focus:ring-orange-600" />
                      <span className="absolute right-3 top-3 text-gray-400">%</span>
                    </div>
                  </div>
                  <div>
                    <label className="block text-gray-400 font-rajdhani mb-2">Period (months) *</label>
                    <input type="text" value="36" className="w-full bg-white border border-orange-600/30 px-4 py-3 text-white font-rajdhani focus:outline-none focus:ring-2 focus:ring-orange-600" />
                  </div>
                  <div>
                ...
                <div className="bg-black/40 border border-orange-600/30 p-6">
