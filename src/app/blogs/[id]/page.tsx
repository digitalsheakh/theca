              ...
              {blog.tags && blog.tags.length > 0 && (
                <div className="flex flex-wrap gap-2 mb-6">
                  {blog.tags.map((tag, index) => (
                    <span
                      key={index}
                      className="px-4 py-2 bg-orange-600/20 text-orange-400 text-xs font-rajdhani font-bold uppercase tracking-wider rounded border border-orange-600/30 hover:bg-orange-600/30 transition-colors"
                    >
                      {tag}
                    </span>
                  ))}
      ...
      <section className="relative w-full py-16 bg-black" style={{backgroundImage: 'url(/images/logos/background-1.jpg)', backgroundSize: 'cover', backgroundPosition: 'center'}}>
        ...
        <div className="w-full px-6 relative z-10">
          <div className="max-w-4xl mx-auto">
            {/* Blog Description */}
            {blog.description && (
              <div className="mb-12 p-8 bg-gray-900/50 border border-orange-600/30 rounded-xl backdrop-blur-sm">
            ...
            <div 
              className="prose prose-invert prose-lg max-w-none 
                         ...
                         prose-blockquote:border-l-4 prose-blockquote:border-orange-600 prose-blockquote:bg-gray-900/50 prose-blockquote:p-6 prose-blockquote:rounded-lg prose-blockquote:italic
                         prose-code:text-orange-400 prose-code:bg-gray-900/50 prose-code:px-2 prose-code:py-1 prose-code:rounded prose-code:font-mono
            ...
            <footer className="mt-16 pt-8 border-t border-gray-700">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <a 
                  href="/blogs"
                  className="inline-flex items-center gap-2 bg-orange-600 hover:bg-orange-700 text-white px-6 py-3 rounded font-rajdhani font-bold uppercase tracking-wider transition-all duration-300"
                >
                  ← Back to Blog
                </a>
              </div>
