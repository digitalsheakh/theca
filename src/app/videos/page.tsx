        ...
        <div className="w-full px-6">
          <div className="max-w-screen-2xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-3 pt-4">
                  <a
                    ...
                    className="flex items-center gap-2 bg-[#FF0000] hover:bg-[#cc0000] text-white px-6 py-3 font-rajdhani font-bold transition-all duration-300"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-6 py-3 font-rajdhani font-bold transition-all duration-300"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 font-rajdhani font-bold transition-all duration-300"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white px-6 py-3 font-rajdhani font-bold transition-all duration-300"
                  >
              ...
              <div className="bg-black/50 p-6 border border-orange-600/30 flex items-center justify-center">
            ...
            <div className="space-y-6 mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                >
                  ...
                  <div className="p-4">
                    <h4 className="text-white font-rajdhani font-bold text-base mb-2 group-hover:text-orange-600 transition-colors line-clamp-2">EP 7: Engine Rebuild Masterclass</h4>
                    <div className="flex items-center justify-between mt-3">
                      <span className="text-orange-600 font-rajdhani text-xs font-bold uppercase flex items-center">
                        <FaYoutube className="mr-1" />
                        Listen Now
                ...
                >
                  ...
                  <div className="p-4">
                    <h4 className="text-white font-rajdhani font-bold text-base mb-2 group-hover:text-orange-600 transition-colors line-clamp-2">EP 8: Customer Stories & Repairs</h4>
                    <div className="flex items-center justify-between mt-3">
                      <span className="text-orange-600 font-rajdhani text-xs font-bold uppercase flex items-center">
                        <FaYoutube className="mr-1" />
                        Listen Now
            ...
            <div className="text-center">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-orange-600 hover:bg-orange-700 text-white px-8 py-4 font-bold font-orbitron uppercase tracking-wider transition-all duration-300 hover:scale-105 active:scale-95"
              >
                <FaYoutube className="text-xl" />
                VIEW ALL EPISODES
              </a>
