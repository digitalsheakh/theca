      ...
      <section className="py-20 bg-black">
        <div className="container mx-auto px-8">
          <div className="max-w-3xl mx-auto">
            {/* Benefits */}
            <div className="mb-12 bg-gray-900 p-8 border border-orange-600/30">
            ...
            {/* Form */}
            <div className="bg-gray-900 p-8 border border-orange-600/30">
              <h3 className="text-2xl font-bold text-white mb-6 font-orbitron uppercase">
                Join Now
              </h3>

              {submitStatus === 'success' && (
                <div className="mb-6 p-4 bg-green-900/30 border border-green-600">
              ...
              {submitStatus === 'error' && (
                <div className="mb-6 p-4 bg-orange-900/30 border border-orange-600">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 bg-white border border-orange-600/30 text-black font-rajdhani focus:outline-none focus:border-orange-600 transition-colors"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className="w-full px-4 py-3 bg-white border border-orange-600/30 text-black font-rajdhani focus:outline-none focus:border-orange-600 transition-colors uppercase"
                ...
                <div className="pt-4">
                  <button
                    ...
                    className="w-full bg-orange-600 hover:bg-orange-700 text-white px-8 py-4 font-bold font-orbitron uppercase tracking-wider transition-all duration-300 hover:scale-105 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
