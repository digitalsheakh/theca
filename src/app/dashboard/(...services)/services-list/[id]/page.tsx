...
`}</style>
 ...
 className="w-full px-5 py-3 bg-white border border-orange-600/30 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent
 ...
 className="w-full pl-8 pr-5 px-5 py-3 bg-white border border-orange-600/30 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent text-black placeholder-gray-500 transition-all duration-200"
 />
 </div>
 {errors.basePrice && (
 <p className="mt-2 text-sm text-orange-400 flex items-center">
