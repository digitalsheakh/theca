        ...
        <div className="py-3">
          <div className="flex gap-2">
            {shop.imageUrls.slice(0, 2).map((imageUrl, index) => (
              <div 
                key={index}
                className="relative h-16 w-16 rounded-lg border-2 border-gray-200 cursor-pointer hover:border-orange-300 hover:shadow-md transition-all duration-200 overflow-hidden bg-white"
