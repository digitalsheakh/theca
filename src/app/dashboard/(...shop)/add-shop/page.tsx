...
'link','image'
 ...
 <div className="border-2 border-dashed border-gray-300 p-6 hover:border-orange-400 transition-colors duration-200 bg-gray-50">
 <input
 type="file"
 id="images"
 multiple
 ...
 className="file:mr-4 file:py-3 file:px-6 file:border-0 file:text-sm file:font-bold file:bg-orange-500 file:text-white hover:file:bg-orange-600 file:transition-all file:duration-200 file:shadow-md hover:file:shadow-lg w-full text-gray-700 font-rajdhani text-base cursor-pointer"
 />
 ...
 src={preview} 
 alt={`Preview ${index + 1}`} 
 className="h-24 w-full object-cover border-2 border-gray-200 shadow-sm group-hover:shadow-md transition-all duration-200"
 />
 <button
 type="button"
 onClick={() => removeImage(index)}
 className="absolute -top-2 -right-2 bg-orange-500 text-white p-1.5 opacity-0 group-hover:opacity-100 transition-all duration-200 hover:bg-orange-600 shadow-lg"
 >
 <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
 <path fillRule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clipRule="evenodd" />
 </svg>
 </button>
 <div className="absolute bottom-1 left-1 bg-black/60 text-white text-xs px-2 py-1 font-rajdhani">
 {index + 1}
 </div>
 </div>
 ))}
