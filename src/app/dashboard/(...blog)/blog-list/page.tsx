  ...
  const columns: ColumnDef<Blog>[] = [
    ...
    },
    {
      ...
      accessor: (blog) => (
        <div className="py-3">
          <div 
            className="relative h-16 w-24 rounded-lg border-2 border-gray-200 cursor-pointer hover:border-orange-300 hover:shadow-md transition-all duration-200 overflow-hidden bg-white"
