      ...
      <div className="p-6">
                  ...
                  <div className="flex flex-col items-center">
                    <div className="relative w-full max-w-md mx-auto">
                      ...
                      <div className="absolute -bottom-3 left-0 right-0 flex justify-center">
                        <span className="px-4 py-2 bg-orange-500 text-white text-sm font-bold rounded-lg shadow-lg font-rajdhani">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-xl border-2 border-blue-200 shadow-sm">
              ...
              <div className="mb-6">
                ...
                <input
                  ...
                  type="text"
                  {...register('metaTitle')}
                  className="w-full px-4 py-3 bg-white border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 text-gray-900 placeholder-gray-500 transition-all duration-200 font-rajdhani"
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 bg-white border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 text-gray-900 placeholder-gray-500 transition-all duration-200 font-rajdhani resize-none"
        ...
        <div className="flex justify-end gap-6 mt-10 pt-6 border-t-2 border-gray-200">
          <button
            ...
            className="inline-flex items-center px-8 py-4 text-base font-bold rounded-lg border-2 border-orange-600 text-orange-600 hover:text-white hover:bg-gradient-to-r hover:from-orange-600 hover:to-orange-700 shadow-lg transition-all duration-200 ease-in-out hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 font-rajdhani uppercase tracking-wide"
          >
