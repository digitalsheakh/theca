...
export function Sidebar() {
 ...
 href="/dashboard"
 className={cn(
"flex items-center gap-3 px-4 py-3 transition-all font-rajdhani font-medium",
 isActive('/dashboard')
 ...
 <div className="flex items-center gap-3 px-3 py-2 mb-2 bg-gray-50">
 ...
 href={item.href}
 className={cn(
"flex items-center gap-3 px-3 py-2 transition-all font-rajdhani text-sm",
 isActive(item.href) 
 ...
 <div className="flex items-center gap-3 cursor-pointer group p-2 hover:bg-[#f97316] transition-colors">
 <Image 
 src={session?.user?.profilePhoto ||'/default-avatar.png'} 
 width={40} 
 height={40} 
 alt='profile pic' 
 className="h-10 w-10 border-2 border-orange-600 shadow-sm"
 priority
 />
