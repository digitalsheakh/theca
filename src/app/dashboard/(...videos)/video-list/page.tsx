  ...
  const columns: ColumnDef<YouTubeVideo>[] = [
    ...
    },
    {
      ...
      accessor: (video) => (
        <div className="py-3">
          <div 
            className="relative h-16 w-28 rounded-lg border-2 border-gray-200 cursor-pointer hover:border-orange-300 hover:shadow-md transition-all duration-200 overflow-hidden bg-black group"
