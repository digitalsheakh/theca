...
'image/*': ['.jpeg','.jpg','.png','.webp']
 ...
 className={`w-full px-5 py-3 bg-white border focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent text-black placeholder-gray-500 transition-all duration-200 ${
 errors.title ?'border-orange-500' :'border-orange-600/30'
 }`}
 />
 {errors.title && (
 ...
 disabled={isSubmitting}
 className={`w-full px-5 py-3 bg-white border focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent text-black placeholder-gray-500 transition-all duration-200 ${
 errors.description ?'border-orange-500' :'border-orange-600/30'
 }`}
 />
 {errors.description && (
 <p className="mt-2 text-sm text-orange-400 flex items-center">
 ...
 disabled={isSubmitting}
 className={`w-full px-5 py-3 bg-white border focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent text-black placeholder-gray-500 transition-all duration-200 ${
 errors.videoEmbedLink ?'border-orange-500' :'border-orange-600/30'
 }`}
 />
 ...
 disabled={isSubmitting}
 className={`w-full px-5 py-3 bg-white border focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent text-black placeholder-gray-500 transition-all duration-200 ${
 errors.videoYoutubeLink ?'border-orange-500' :'border-orange-600/30'
 }`}
 />
 ...
 disabled={isSubmitting}
 className={`w-full px-5 py-3 bg-white border focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent text-black placeholder-gray-500 transition-all duration-200 ${
 errors.videoThumbnail ?'border-orange-500' :'border-orange-600/30'
 }`}
 />
 ...
 {...register('metaTitle')}
 disabled={isSubmitting}
 className={`w-full px-3 py-2 bg-white border focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent text-black placeholder-gray-400 transition-all duration-200 ${
