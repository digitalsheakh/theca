          ...
          {activeTab === "tutorial" && (
            <div className="p-8">
              ...
              <div className="space-y-8">
                <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-6 border-2 border-orange-200 shadow-lg">
                  <iframe
                    className="w-full h-96 shadow-lg border-2 border-white"
          ...
          {activeTab === "profile" && (
            <div className="p-8">
              ...
              <form onSubmit={handleProfileSubmit(onSubmitProfile)} className="space-y-8">
                <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-6 border-2 border-gray-200 shadow-sm">
                  <div className="flex items-center justify-center mb-6">
                    <div className="relative">
                      {adminPhoto ? (
                        <img src={adminPhoto} alt="Profile" className="h-32 w-32 object-cover border-4 border-white shadow-lg" />
                      ) : (
                        <div className="h-32 w-32 bg-gradient-to-br from-gray-300 to-gray-400 flex items-center justify-center border-4 border-white shadow-lg">
                          <span className="text-gray-600 font-rajdhani font-bold">No Photo</span>
                        </div>
                      )}
                      <div className="absolute bottom-0 right-0 bg-orange-500 p-2 shadow-lg">
                  ...
                  {isEditMode && (
                    <div className="mt-4">
                      ...
                      <input
                        ...
                        className="block w-full text-sm text-gray-700 file:mr-4 file:py-3 file:px-6 file:border-0 file:text-sm file:font-bold file:bg-orange-500 file:text-white hover:file:bg-orange-600 file:transition-all file:duration-200 file:shadow-md hover:file:shadow-lg cursor-pointer font-rajdhani"
                      />
                    </div>
                  )}
                </div>
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                  <div>
                    ...
                    <input
                      ...
                      disabled={!isEditMode}
                      className={`w-full px-5 py-4 bg-white border-2 border-gray-300 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 text-gray-900 placeholder-gray-500 transition-all duration-200 font-rajdhani text-base ${!isEditMode ? "bg-gray-50 cursor-not-allowed" : ""
