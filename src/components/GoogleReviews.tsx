...
export default function GoogleReviews({ darkMode = false, limit = 3 }: GoogleReviewsProps) {
 ...
 return (
 <div className={`${bgColor} py-12 border-t border-white/20`}>
 ...
 {reviews.map((review) => (
 <div key={review.id} className={`${cardBgColor} p-6 border border-orange-600/30 shadow-xl hover:shadow-2xl transition-all duration-300 hover:border-orange-600/30`}>
 <div className="flex items-center mb-4">
 <div className="bg-gradient-to-br from-orange-500 to-orange-600 w-10 h-10 flex items-center justify-center mr-3 shadow-md">
 ...
 className="inline-flex items-center bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 font-bold transition-colors duration-300 shadow-lg transform hover:scale-105"
 >
