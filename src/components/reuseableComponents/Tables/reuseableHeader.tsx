...
const SearchInput: React.FC<SearchInputProps> = ({ 
 ...
 return (
 <div className="mb-8 bg-gradient-to-r from-gray-50 via-white to-gray-50 shadow-sm border border-gray-200">
 {heading && (
 ...
 <input
 type="text"
 className="w-full pl-12 pr-4 py-3 text-base border-2 border-gray-300 focus:border-gray-500 focus:ring-2 focus:ring-gray-200 focus:outline-none text-gray-900 placeholder-gray-500 transition-all duration-200 font-rajdhani shadow-sm"
 ...
 <div className="flex flex-col lg:flex-row justify-between items-center gap-4 p-4 bg-gray-50 border border-gray-200">
 {onLimitChange && (
 ...
 className="w-20 border-2 border-gray-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-gray-500 text-gray-900 font-rajdhani font-medium bg-white shadow-sm"
 >
 ...
 <div className="text-sm font-medium text-gray-700 font-rajdhani bg-white px-4 py-2 border border-gray-200 shadow-sm">
