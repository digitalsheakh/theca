...
export default function VideoPlayer({ videoId, thumbnailSrc }: VideoPlayerProps) {
 ...
 <div className="w-20 h-20 bg-orange-600 flex items-center justify-center shadow-2xl group-hover:scale-110 transition-transform duration-300 group-hover:bg-orange-700">
