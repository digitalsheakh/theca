        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              <button className="bg-white hover:bg-gray-100 text-black font-medium py-2 px-4 transition duration-300 flex items-center">
                <span className="mr-2">+</span> EXPLORE SERVICES
              </button>
              <button className="bg-primary-500 hover:bg-primary-600 text-white font-medium py-2 px-4 transition duration-300 flex items-center">
