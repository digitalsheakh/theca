...
'Personalized Care'
 ...
 className={`px-6 py-2 text-sm font-medium ${activeSection ==='maintenance' ?'bg-[#ff0000] text-white' :'bg-white text-gray-300 hover:bg-[#f97316]'} focus:z-10 focus:outline-none`}
 >
 ...
 className={`px-6 py-2 text-sm font-medium ${activeSection ==='specialist' ?'bg-[#ff0000] text-white' :'bg-white text-gray-300 hover:bg-[#f97316]'} focus:z-10 focus:outline-none`}
 >
 ...
 * Prices may vary based on vehicle make and model.
 ...
 <div key={service.id} className="bg-white overflow-hidden shadow-lg transform transition-transform duration-300 hover:scale-105">
 <div className="p-6">
